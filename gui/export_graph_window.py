...
class ExportGraph(QWidget):
    ...
    def __init__(self, window, top: bool):
        ...
        self.trim_whitespace_checkbox.setObjectName("trim_whitespace_checkbox")
    ...
    def retranslateUi(self, Form):
        self.path_label.setText(QCoreApplication.translate("Form", "Path", None))
        self.file_explorer_button.setText(
            QCoreApplication.translate("Form", "..", None)
        )
        self.export_button.setText(QCoreApplication.translate("Form", "Export", None))
        self.trim_whitespace_checkbox.setText(
            QCoreApplication.translate("Form", "TrimWhitespace", None)
        )  # retranslateUi          # ui functionality
    ...
    def export_graph(self):
        path = self.config[
            "default_report_path"
        ]  # TODO maybe make this its own config item!
