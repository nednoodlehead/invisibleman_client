...
class NotesWindow(QWidget):
     ...
     def __init__(self, uuid: str):
          super().__init__()
          self.uuid = uuid
          notes = fetch_notes_from_uuid(self.uuid)  # notes are found here so when updating with new notes, the button returns the right data
          ...
          self.notes_window_update_text.setObjectName(u"notes_window_update_text")
