...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QWidget.setTabOrder(self.insert_price_spinbox, self.insert_asset_category_combobox)
        ...
        QWidget.setTabOrder(self.insert_install_date_fmt, self.insert_replacement_date_fmt)
