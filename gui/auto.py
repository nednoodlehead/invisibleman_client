...
################################################################################
## Form generated from reading UI file 'inventory_manageryKQLFu.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QWidget.setTabOrder(self.insert_asset_type_combobox, self.insert_manufacturer_combobox)
        QWidget.setTabOrder(self.insert_manufacturer_combobox, self.insert_serial_text)
        ...
        QWidget.setTabOrder(self.insert_cost_spinbox, self.insert_assigned_to_text)
        QWidget.setTabOrder(self.insert_assigned_to_text, self.insert_name_text)
        QWidget.setTabOrder(self.insert_name_text, self.insert_asset_location_combobox)
        QWidget.setTabOrder(self.insert_asset_location_combobox, self.insert_asset_category_combobox)
        QWidget.setTabOrder(self.insert_asset_category_combobox, self.insert_deployment_date_fmt)
        QWidget.setTabOrder(self.insert_deployment_date_fmt, self.insert_replacement_date_fmt)
        QWidget.setTabOrder(self.insert_replacement_date_fmt, self.insert_status_bool)
        QWidget.setTabOrder(self.insert_status_bool, self.insert_notes_text)
        QWidget.setTabOrder(self.insert_notes_text, self.insert_conditional_retirement_date_fmt)
        QWidget.setTabOrder(self.insert_conditional_retirement_date_fmt, self.insert_insert_button)
        QWidget.setTabOrder(self.insert_insert_button, self.checkbox_replacementdate)
        QWidget.setTabOrder(self.checkbox_replacementdate, self.checkbox_model)
        ...
        QWidget.setTabOrder(self.filter_options_combobox, self.insert_asset_type_add_option)
        QWidget.setTabOrder(self.insert_asset_type_add_option, self.filter_user_text)
        ...
        QWidget.setTabOrder(self.checkbox_cost, self.insert_clear_selections_button)
        QWidget.setTabOrder(self.insert_clear_selections_button, self.ham_button_view)
        QWidget.setTabOrder(self.ham_button_view, self.insert_asset_category_add_option)
        QWidget.setTabOrder(self.insert_asset_category_add_option, self.checkbox_deploymentdate)
        QWidget.setTabOrder(self.checkbox_deploymentdate, self.insert_asset_location_add_option)
        ...
        QWidget.setTabOrder(self.settings_report_auto_open_checkbox, self.checkbox_view_retired_assets)
        QWidget.setTabOrder(self.checkbox_view_retired_assets, self.checkbox_notes)
        QWidget.setTabOrder(self.checkbox_notes, self.insert_manufacturer_add_option)
        QWidget.setTabOrder(self.insert_manufacturer_add_option, self.checkbox_assetlocation)
        QWidget.setTabOrder(self.checkbox_assetlocation, self.insert_serial_is_unique_button)
        QWidget.setTabOrder(self.insert_serial_is_unique_button, self.settings_file_dialog_button)
        QWidget.setTabOrder(self.settings_file_dialog_button, self.checkbox_assignedto)
        QWidget.setTabOrder(self.checkbox_assignedto, self.checkbox_name)
